...
const LeftPanel = () => (
  <div className="hidden lg:flex lg:w-1/2 flex-col justify-between p-12 relative overflow-hidden"
    ...
    <p className="relative z-10 text-white/40 text-xs">© 2026 SANARIS — ITM Medellín</p>
  </div>
);
    ...
    <div className="min-h-screen flex">
      ...
      <div className="flex-1 flex items-center justify-center p-6 sm:p-12 bg-background">
        <div className="w-full max-w-md space-y-8">
            ...
            <>
              ...
              <div className="relative">
                ...
                <div className="relative flex justify-center text-xs uppercase">
                  <span className="bg-white px-3 text-muted-foreground text-xs">o continuar con</span>
                </div>
              </div>
          ...
          {/* PASO 2 — PERFIL (registro y google) */}
          {step === 2 && (
            <>
              <div>
              ...
              <form onSubmit={handleStep2} className="space-y-5">
                ...
                <div className="space-y-2">
                  <Label>Rol en el hospital</Label>
